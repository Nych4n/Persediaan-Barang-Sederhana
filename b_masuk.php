...
if (isset($_POST['fillter_tgl'])) {
    ...
    $ambilsemuadata = mysqli_query($conn,"SELECT * FROM  barang_masuk INNER JOIN barang 
    ON barang_masuk.id_barang = barang.id_barang WHERE tgl_masuk >= '$mulai' AND tgl_masuk <= '$selesai'");                                            
}else {
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        ...
                                        <i class="ti-upload btn-icon-prepend"></i> data masuk
                                    </button>
                                    <?php }?>
                                    ...
                                    <table class="table table-hover text-center">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php if ($_SESSION['level']=="admin") {?>
                                                <td>
                                                    <a href="model.php?hapus=<?php echo $data['id_masuk'];?>"
                ...
                <form action="_crud.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="basic-default-company"
                            placeholder="Masukkan jumlah barang masuk" name="jumlah" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="basic-default-company">Penerima</label>
                        <input type="text" class="form-control" id="basic-default-company"
                            placeholder="Masukkan penerima" name="Keterangan" />
                    </div>
                    <div class="mb-3">
                        <button type="submit" name="simpan_masuk" class="btn btn-primary">Simpan</button>
                </form>
