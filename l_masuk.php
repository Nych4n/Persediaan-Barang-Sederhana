...
$pdf->Cell(200,10,' LAPORAN DATA BARANG MASUK',0,0,'C');
...
// Ambil Data
$query = "SELECT * FROM barang_masuk INNER JOIN barang ON barang_masuk.id_barang = barang.id_barang";
...
foreach($dataproduk as $data){
    ...
    $pdf->Cell(40,8,$data['tgl_masuk'],1,0);
